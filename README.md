...
This project presents a basic desktop application used to make simple algebric operations while displaying amusing duck quacks or cow moos. 
...
The calculator takes input expressions of the form 'a operator b'.
